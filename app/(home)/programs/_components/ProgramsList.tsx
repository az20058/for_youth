...
async function fetchPrograms(page: number, category: string): Promise<ProgramsResponse> {
...
export function ProgramsList() {
  ...
  const { data, isLoading, isFetching } = useQuery({
    queryKey: ['programs', page, activeCategory],
    queryFn: () => fetchPrograms(page, activeCategory),
